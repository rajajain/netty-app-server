...
public class TestController implements IBaseRequestHandler {
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/v1/search/test-method1", responseType = ResponseType.JSON)
    ...
    @RequestMapping(method = RequestMethod.POST, value = "/v1/search/test-method2", responseType = ResponseType.JSON)
